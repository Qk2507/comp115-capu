...
print("\nExercise 5")
day_today = int(input("Today's day number of the week:"))
days_trip = int(input("Trip duration:"))
final_output = (day_today + days_trip) % 7 
print(f"Your trip starts on day {day_today}, lasts {days_trip}. You are back on day {final_output}.")
